...
def accuracymeasures(y_test, predictions, avg_method, target_names):
...
def get_feat_and_target(df, feature, target):
    """
...
def get_target_names(df, target):
...
def train_and_evaluate(config_path):
    ...
    with mlflow.start_run(run_name=mlflow_config["run_name"]) as mlops_run:
        ...
        model_details = mlflow.register_model(model_uri=model_uri, name=model_path)
        print(model_details)
